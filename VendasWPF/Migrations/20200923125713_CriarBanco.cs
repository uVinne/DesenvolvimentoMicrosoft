    ...
    public partial class CriarBanco : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ÏtensVenda", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ÏtensVenda_Produtos_ProdutoId",
                        column: x => x.ProdutoId,
                        principalTable: "Produtos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ÏtensVenda_Vendas_VendaId",
                        column: x => x.VendaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ÏtensVenda_ProdutoId",
                table: "ÏtensVenda",
                column: "ProdutoId");

            migrationBuilder.CreateIndex(
                name: "IX_ÏtensVenda_VendaId",
                table: "ÏtensVenda",
                column: "VendaId");
